...
const APPLICATION_LIST = [
    {
        key: ApplicationInfo.BoilerplateAppInfo.name,
        title: <a href={`${window.location.origin}?${APPLICATION_PARAM_KEY}=${ApplicationInfo.BoilerplateAppInfo.name}`}>Boilerplate</a>,
